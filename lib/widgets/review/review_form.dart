...
class ReviewForm extends StatefulWidget {
  final String? restaurantId; // Set for Supabase restaurant
  final String? placeId;      // Set for Google Place API restaurant
...
class _ReviewFormState extends State<ReviewForm> {
  ...
  int? _rating; // null until chosen
  bool _isSubmitting = false;
  bool _expanded = false; // controls expansion panel
