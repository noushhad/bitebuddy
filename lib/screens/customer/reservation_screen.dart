...
//     setState(() => _submitting = true);
//     try {
//       // 1) Insert and get the new reservation id back
...
//             'created_at': DateTime.now().toIso8601String(),
//           })
//           .select('id') // <-- important to return id
//           .single();

//       final String reservationId = inserted['id'] as String;

//       // 2) Immediately notify the OWNER via Edge Function
//       await _supabase.functions.invoke(
//         'push-onesignal',
//         body: {
//           'type': 'owner_new_reservation',
