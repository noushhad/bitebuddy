...
Performed functional & UI testing across Android and iOS builds

Conducted API testing using Postman (auth, reservations, reviews)

Reported and tracked bugs in a Jira-style workflow
...
🗺️ Restaurant search with filters (cuisine, radius, open now, tags)

⭐ Favorites for quick access

📝 Customer reviews & ratings

📅 Reservation system (create/cancel/manage)

🧾 Owner menu management with images
